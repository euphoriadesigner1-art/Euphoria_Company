...
export function BeamsBackground({
    ...
    useEffect(() => {
        ...
        function drawBeam(ctx: CanvasRenderingContext2D, beam: Beam) {
            ...
            // Enhanced gradient with multiple color stops - adapted for Electric Blue / Gold theme
    ...
    return (
        <div
            className={cn(
                "absolute inset-0 w-full overflow-hidden pointer-events-none mix-blend-screen z-0",
                className
            )}
        >
            <canvas
